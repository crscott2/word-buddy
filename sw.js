/* Word Buddy service worker — v1.28: network-first shell so version UI updates; skipWaiting + clients.claim; offline assets still cached */
var CACHE = "word-buddy-v1.28";
var ASSETS = [
  "./",
  "./index.html",
  "./css/style.css",
